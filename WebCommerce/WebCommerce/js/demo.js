...
$(function() {
    ...
    $btnSesamo.on('click', 'a', function(e) {
        ...
        $btnSesamo.children('span').text('').addClass('icon-spinner icon-spin icon-large')

        if(this.id == 'bs2') src = "./index.php";
        if(this.id == 'bs3') src = "./phpbb31/index.php";
        ...
        if(isMobileSafari) {
            ...
            $('#iframe').one('load', function() {
                ...
                setTimeout(function() {
                    ...
                    $btnSesamo.children('span').removeClass('icon-spinner icon-spin icon-large').text('or')
                },500)
            }).attr('src', src);
        }
